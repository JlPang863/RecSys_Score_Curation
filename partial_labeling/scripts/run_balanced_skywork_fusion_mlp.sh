...
DATASET_PATH="raw_data/tulu_balanced_18k.parquet"
...
echo "=========================================================="
echo "*** Balanced 18k — Skywork Fusion MLP ***"
echo "=========================================================="
echo "dataset=${DATASET_PATH}"
echo "embedding_npy=${EMBEDDING_NPY}"
echo "model=${MODEL}, hidden_dim=${HIDDEN_DIM}, epochs=${EPOCHS}"
echo "data_pool_size=${DATA_POOL_SIZE} (balanced: 3000 per class)"
...
for TRAIN_RATIO in "${TRAIN_RATIOS[@]}"; do
    ...
    OUTPUT_DIR="${ROOT_RESULT_PATH}/balanced_skywork_fusion_mlp_${TR_NAME}"

...
TRAIN_RATIOS=(0.10 0.50 0.70 0.90 0.95)

echo "======================================================"
echo "*** Skywork Fusion MLP — 300k data pool ***"
echo "======================================================"
...
for TRAIN_RATIO in "${TRAIN_RATIOS[@]}"; do
    ...
    OUTPUT_DIR="${ROOT_RESULT_PATH}/skywork_fusion_mlp_300k_${TR_NAME}"

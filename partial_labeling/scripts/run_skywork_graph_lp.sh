...
echo "============================================================"
echo "*** Graph LP: C&S + APPNP (with hyperparameter sweep) ***"
echo "============================================================"
...
for TRAIN_RATIO in "${TRAIN_RATIOS[@]}"; do
    ...
    OUTPUT_DIR="${ROOT_RESULT_PATH}/skywork_graph_lp_${TR_NAME}"
    ...
    CUDA_VISIBLE_DEVICES=4 python partial_labeling/graph_lp_proxy.py \
...
echo ""
echo "============================================================"
echo "All Graph LP runs completed!"
echo "============================================================"

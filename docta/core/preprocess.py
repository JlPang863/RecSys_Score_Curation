...
def save_extracted_dataset(cfg, dataset_embedding, dataset_label, dataset_idx, save_cnt):
    ...
    save_path = os.path.join(cfg.save_path, f'embedded_{cfg.dataset_type}_{save_cnt}.pt')
...
def extract_embedding(cfg, encoder, dataset_list):
    ...
    for dataset in dataset_list:
        ...
        for i, batch in tqdm(enumerate(train_loader)):
            ...
            ###save the data after save_num batches 
            if (i+1) % save_num == 0:
...
class Preprocess:
    ...
    def get_encoder(self):
        ...
        elif 'large-en-v1.5' in self.cfg.embedding_model:
